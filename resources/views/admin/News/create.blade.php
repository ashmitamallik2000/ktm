...
<div class="card  bd-highlight">
    <div class="d-flex justify-content-between">
        <div>
            <h4 class="py-3 ms-4">News and Information</h4>
        </div>
        <div>
            <a href="{{ route('admin.news.index') }}">
                <button type="button" class="btn btn-primary mt-3 me-3">News List</button></a>
        </div>
    </div>
</div>
<!-- 
        ...
        <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mt-3">
                ...
                <div class=" col-md-6 my-3">
                    ...
                    <select id="information_id" name="information_id" class="bg-white border border-2 " style="height:39px; width:28rem; border-radius:8px; ">
