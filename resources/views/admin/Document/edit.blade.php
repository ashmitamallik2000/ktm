        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb me-3">
                <li class="breadcrumb-item"> <a href="{{route('admin.dashboard')}}">
                        Home</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="{{route('admin.document.index')}}">Publication-Category
                    </a></li>
            </ol>
        </nav>
    </div>
...
<div class="card  bd-highlight">
    <div class="d-flex justify-content-between">
        <div>
            <h4 class="py-3 ms-4">Publication-Category</h4>
        </div>
        <div>
            <a href="{{ route('admin.document.index') }}">
                <button type="button" class="btn btn-primary mt-3 me-3">Publication-Category List</button></a>
        </div>
    </div>
</div>
<div class="card">
