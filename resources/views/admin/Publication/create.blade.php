        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb me-3">
                <li class="breadcrumb-item"> <a href="{{ route('admin.dashboard') }}">
                        Home</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.publication.index') }}">Publication
                    </a></li>
            </ol>
        </nav>
    </div>
    ...
    <div class="d-flex justify-content-between">
        ...
        <div>
            <a href="{{ route('admin.publication.index') }}">
                <button type="button" class="btn btn-primary mt-3 me-3">Publication List</button></a>
        </div>
    </div>
</div>
<!-- 
        ...
        <form action="{{ route('admin.publication.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mt-3">
                ...
                <div class=" col-md-5 my-3">
                    ...
                    <select id="document_id" name="document_id" class="bg-white border border-2 " style="height:39px; width:28rem; border-radius:8px; ">
